...
int main() {
    ...
    DealerCacheTable dealer_cache_table = make_dealer_cache_table();

    double dealer_ev_result = dealer_ev(&dealer_cache_table, player_hand, dealer_hand, deck, s17);

    printf("Cache size: %i\n", dealer_cache_table.size);
